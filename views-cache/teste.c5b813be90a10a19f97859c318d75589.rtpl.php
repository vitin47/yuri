							...
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="/single/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="link-product-add-cart">Ver Detalhes</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										...
										<del>R$<?php echo formatPrice($value1["vlprice"] + 20); ?></del>
									</div>
