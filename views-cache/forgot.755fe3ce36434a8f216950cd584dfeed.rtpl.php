                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Para redefinir a sua senha clique <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>}</a>.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Qualquer dúvida</b></a> contate o suporte
          </div>
        </td>
        <td></td>
      </tr>
