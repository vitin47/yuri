                    ...
                    <div class="woocommerce">
                        ...
                        <form action="/checkout">
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells col-sm-4">

                                    <h2>Cálculo de Frete</h2>
                                    
                                    <div class="coupon">
                                        <label for="cep">CEP:</label>
                                        <input type="text" placeholder="00000-000" required="true" value="" id="cep" class="input-text" name="zipcode">
                        ...
                        <div class="w3-container">
                          <h2>Contrato</h2>
                          <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Abrir o contrato</button>
