...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Jun-2019 às 01:13
...
(4, 'Manutenção', '2019-05-23 13:10:30'),
...
--
ALTER TABLE `tb_addresses`
  MODIFY `idaddress` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `tb_cartsproducts`
  MODIFY `idcartproduct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
